...
class AppColors {
  //scanner
  static const Color primary0DAAAA = Color(0xff0DAAAA);
  static const Color primary004848 = Color(0xff004848);
  static const Color primary051E56 = Color(0xff051E56);
  static const Color primary0DABAB = Color(0xff0DABAB);
  static const Color primary88c4c4 = Color(0xff88c4c4);
  static const Color primaryd6cef5 = Color(0xffd6cef5);
  static const Color primary9CA5BA = Color(0xff9CA5BA);
  static const Color primaryE0FFFF = Color(0xffE0FFFF);
  static const Color primaryFFE0E0 = Color(0xffFFE0E0);
  static const Color primaryF12020 = Color(0xffF12020);
  static const Color primaryEEF2F9 = Color(0xffEEF2F9);
  static const Color primaryB3BCCF = Color(0xffB3BCCF);
  static const Color primaryFFCB5D = Color(0xffFFCB5D);
  static const Color primaryF5F8FD = Color(0xffF5F8FD);
  static const Color primarye9f4f4 = Color(0xffe9f4f4);
  static const Color primaryFFF5DD = Color(0xffFFF5DD);
  ...
  static const LinearGradient skeleton = LinearGradient(colors: [
    Color(0xFFE7E8EE),
    Color(0xFFF7F7F8),
  ]);
  static const LinearGradient gradientOrangeA500 = LinearGradient(colors: [
    Color(0xFFFFC800),
    Color(0xFFFF9C09),
  ]);
  static const LinearGradient gradientRedA500 = LinearGradient(colors: [
    Color(0xFFE6514A),
    Color(0xFFE57536),
  ]);
  static const LinearGradient gradientBlueA500 = LinearGradient(colors: [
    Color(0xFF98A2FF),
    Color(0xFF4659FF),
  ]);
